...
public static unsafe partial class ImAnimNative
{
    ...
    [LibraryImport(LibName, EntryPoint = "c_iam_set_imgui_allocator_functions")]
    public static partial void SetImGuiAllocatorFunctions(ImGuiMemAllocFunc alloc_func, ImGuiMemFreeFunc free_func, void* user_data);

    [LibraryImport(LibName, EntryPoint = "c_iam_set_imgui_allocator_functions")]
    public static partial void SetImGuiAllocatorFunctions(delegate*<nuint, void*, void*> alloc_func, delegate*<void*, void*, void> free_func, void* user_data);
    ...
    [LibraryImport(LibName, EntryPoint = "c_iam_pool_clear")]
    public static partial void PoolClear();
    ...
    [LibraryImport(LibName, EntryPoint = "c_iam_instance_destroy")]
    public static partial void InstanceDestroy(ImAnimInstance* self);
